...
public class MariaYahooJPRealtimeTwit { 
    public static void main(String[] args) throws Exception {
    	...
    	String pageUrl="http://searchranking.yahoo.co.jp/realtime_buzz/"; 

        Document doc = Jsoup.connect( pageUrl ).get(); 
  
        System.out.println(doc);
        String selector="div#main > div.listRowlink > ul.patf > li > h3 > a"; // css selector
