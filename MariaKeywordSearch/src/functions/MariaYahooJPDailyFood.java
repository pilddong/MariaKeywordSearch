...
public class MariaYahooJPDailyFood { 
    public static void main(String[] args) throws Exception {
    	...
    	String pageUrl="http://searchranking.yahoo.co.jp/gourmet_buzz/"; 

        Document doc = Jsoup.connect( pageUrl ).get(); 
  
        System.out.println(doc);
        String selector="div#main > div.listRowlink > ul.patC > li > a"; // css selector
